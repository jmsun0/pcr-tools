...
import com.sjm.common.mini.springboot.support.ClassScaner;
import com.sjm.common.mini.springboot.support.SpringException;
...
public class SpringApplication {
    ...
    public void run(String... args) throws Exception {
        this.args = args;
        ClassScaner.scan(clazz.getPackage().getName(), true, this::scanAnnotationClasses);
        List<Class<?>> componentClassList = annotationClassesMap.get(Component.class);
        if (componentClassList.isEmpty()) {
            logger.warn("no component found");
            return;
        }
